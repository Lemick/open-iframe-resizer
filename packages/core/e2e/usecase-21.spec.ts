...
test("Should not resize cross origin iframe until button triggers imperative resize", async ({ page }) => {
  await page.goto("/usecases/21-imperative-resize-cross-origin/index.html");
